 ...
 */
#define CFG_GAP_DEVICE_NAME             "DTS-SRV"
...
//[JT] - Created this for my own user events, above what CFG_IdleEvt_Id_t defined
typedef enum
{
    CFG_MY_IDLEEVT_CONN_UPDATE_COMPLETE,    
} CFG_myIdleEvt_Id_t;
...
typedef enum
{
    ...
    CFG_TASK_SW2_BUTTON_PUSHED_ID,   //[JT]
    CFG_TASK_START_NOTIFICATIONS_ID, //[JT]
    CFG_TASK_LINK_CONFIG_ID,         //[JT]   
