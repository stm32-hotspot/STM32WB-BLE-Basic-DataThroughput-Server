...
//#define PAYLOAD_TX_INTERVAL (25000 / CFG_TS_TICK_VAL)  /* Timer Interval - 25ms */    //[JT]
#define PAYLOAD_TX_INTERVAL (1000 / CFG_TS_TICK_VAL)  /* Timer Interval - 100ms */    //[JT]

#define BYTES_PER_PACKET 240  //[JT]
/* USER CODE END ET */
